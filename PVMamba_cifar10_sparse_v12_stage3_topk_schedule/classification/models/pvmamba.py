...
class PVMAMBA(nn.Module):
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        for i_layer in range(self.num_layers):
            ...
            stage_sparse_topk = 3 if stage_enable_sparse else 2
    ...
    def update_sparse_schedule(self, epoch):
        ...
        self.set_stage3_sparse_enable(True)
        self.set_stage3_sparse_topk(new_topk)

        print(f"[SparseSchedule] epoch={epoch}, stage3_enable_sparse=True, stage3_topk={new_topk}")

...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            checkpoint=
            '/home/jlx_75/PVMamba_cifar10_sparse_v13_stage3_latesparse/segmentation/pretrained/pvmamba_v13_cls_backbone.pth',
            type='Pretrained'),
        mlp_ratio=4.0,
        num_heads=[
            2,
...
work_dir = './work_dirs/pvmamba_tiny_upernet_ade20k_v2'

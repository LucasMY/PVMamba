...
model = dict(
    auxiliary_head=dict(
        act_cfg=dict(inplace=False, type='ReLU'),
        align_corners=False,
        channels=256,
        concat_input=False,
        dropout_ratio=0.1,
...
train_cfg = dict(max_iters=16000, type='IterBasedTrainLoop', val_interval=4000)
...
work_dir = 'work_dirs/base_ade20k_random_16000_fixrelu'
